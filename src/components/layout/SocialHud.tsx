...
export default function SocialHud() {
  ...
  const hudClass = isLightPage
    ? "text-zinc-600 hover:text-black border-zinc-300 hover:border-black"
    : "text-zinc-400 hover:text-white border-[#444748] hover:border-white";

  const dividerClass = isLightPage ? "bg-zinc-300" : "bg-[#444748]";

  return (
    <div className="fixed right-6 bottom-12 hidden md:flex flex-col items-center space-y-6 z-40">
      <div className="flex flex-col space-y-4">
        ...
        <a
          ...
          className={`p-1.5 border transition-colors flex items-center justify-center ${hudClass}`}
          title="GitHub"
        >
