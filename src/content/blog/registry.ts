    ...
    sections: [
      {
        ...
        paragraphs: [
          "Hi, I'm Utkarsh Mishra. I'm an Electronics and Instrumentation Engineering student, builder, researcher, entrepreneur, content creator, and lifelong learner who is fascinated by one question: 'How do we build the future?'[cite: 1]",
          ...
          "Currently, I am pursuing my B.Tech in Electronics and Instrumentation Engineering at SRM Institute of Science and Technology (SRMIST), where I balance academics with a variety of technical, research, and entrepreneurial projects. I believe the best way to learn is by building.[cite: 1]"
        ]
      },
      {
      ...
      },
      {
        ...
        listItems: [
          ...
          "Computer Vision & Pattern Recognition[cite: 1]",
      ...
      },
      {
        ...
        listItems: [
          "ESP32 Development & RTOS Environments[cite: 1]",
          "Microcontroller Architecture Programming[cite: 1]",
          "Sensor Integration & Real-Time Data Acquisition[cite: 1]",
          "Distributed IoT Mesh Systems[cite: 1]",
      ...
      },
      {
        ...
        paragraphs: [
          "One of my strongest interests lies in robotics[cite: 1]. I'm fascinated by machines that can navigate autonomously, balance dynamically, perceive their surroundings, and learn through interaction. My projects focus heavily on combining perception networks with physical mechanical nodes."
        ],
        listItems: [
          "Autonomous Vehicles & Kinematics[cite: 1]",
          "Drone Hardware Architecture",
          "Robot Perception & Object Tracking Networks",
          "Simulation Environments such as NVIDIA Isaac Sim & Gazebo[cite: 1]"
        ]
      },
      {
        ...
        listItems: [
          "Fusion 360 CAD Workspace Modeling[cite: 1]",
          "Blender CGI & Environmental VFX Compositing[cite: 1]",
          "3D Printing, Prototyping & Rapid Manufacturing[cite: 1]",
      ...
      },
      {
        ...
        paragraphs: [
          "Alongside engineering, I have a strong entrepreneurial mindset. Having worked in startup and business environments, I've learned that building technology is only one part of the challenge. Understanding people, markets, communication, and execution is equally important[cite: 1]. I enjoy solving problems not just as an engineer, but as a builder who wants ideas to reach the real world.",
      ...
      },
      {
        ...
        paragraphs: [
          "While technology is a major part of my life, it's not the only thing that defines me. I actively pursue cinematic filmmaking, technical writing, visual storytelling, beatboxing, photography, and 3D art rendering[cite: 1].",
